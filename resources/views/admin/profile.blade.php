...
<div class="row">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <li class=""><a href="#changeinfo" data-toggle="tab" aria-expanded="false">Admin Information</a></li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane active" id="activity">
                <form class="form-horizontal" method="POST" action="{{ route('admin.profile.password.update') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
